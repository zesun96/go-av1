...
// WarpFilter is the normative AV1 warped-motion interpolation filter.
// It covers phases [-1, 2] in 1/64-pel increments; the final row is the
// duplicated upper guard used by the phase-index rounding rule.
var WarpFilter = [193][8]int8{
	{0, 0, 127, 1, 0, 0, 0, 0},
	{0, -1, 127, 2, 0, 0, 0, 0},
	{1, -3, 127, 4, -1, 0, 0, 0},
	{1, -4, 126, 6, -2, 1, 0, 0},
