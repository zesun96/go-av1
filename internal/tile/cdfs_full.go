...
// Source: dav1d m.skip_mode, converted from forward CDF1 values.
var SkipModeCDFDefault = [3][2]uint16{
	{147, 0},   // CDF1(32621)
	{12060, 0}, // CDF1(20708)
	{24641, 0}, // CDF1(8127)
}
...
// SegPredCDFDefault is used by temporal segmentation prediction. The context
// is the sum of the above and left seg_pred flags.
var SegPredCDFDefault = [3][2]uint16{
	{16384, 0},
	{16384, 0},
	{16384, 0},
}
...
var InterIntraCDFDefault = [4][2]uint16{
	{16384, 0}, {5881, 0}, {5171, 0}, {2531, 0},
}

var InterIntraModeCDFDefault = [4][5]uint16{
...
var InterIntraWedgeCDFDefault = [7][2]uint16{
	{12732, 0}, {7811, 0}, {6064, 0}, {5238, 0}, {3204, 0}, {3324, 0}, {5896, 0},
}

var WedgeIdxCDFDefault = [9][17]uint16{
...
// Three motion modes: translation, OBMC, local warp.
var MotionModeCDFDefault = [NBlockSizes][4]uint16{
	BS8x8:     {25117, 8008, 0, 0},
	BS8x16:    {28030, 8003, 0, 0},
	BS8x32:    {3969, 1378, 0, 0},
	BS16x8:    {27377, 7240, 0, 0},
	BS16x16:   {13349, 5958, 0, 0},
	BS16x32:   {27645, 9162, 0, 0},
	BS16x64:   {3795, 1174, 0, 0},
	BS32x8:    {6337, 1994, 0, 0},
	BS32x16:   {21162, 8460, 0, 0},
	BS32x32:   {6508, 3652, 0, 0},
	BS32x64:   {12408, 4706, 0, 0},
	BS64x16:   {3026, 1565, 0, 0},
	BS64x32:   {11089, 5938, 0, 0},
	BS64x64:   {3252, 2067, 0, 0},
	BS64x128:  {3870, 2371, 0, 0},
	BS128x64:  {1890, 1433, 0, 0},
	BS128x128: {261, 210, 0, 0},
}

var OBMCCDFDefault = [NBlockSizes][2]uint16{
	BS8x8:     {22331, 0},
	BS8x16:    {23397, 0},
	BS8x32:    {9104, 0},
	BS16x8:    {23467, 0},
...
var CompDirCDFDefault = [5][2]uint16{
	{31570, 0}, {30698, 0}, {23602, 0}, {25269, 0}, {10293, 0},
}

var CompFwdRefCDFDefault = [3][3][2]uint16{
	{{27822, 0}, {12877, 0}, {2037, 0}},
	{{23300, 0}, {10327, 0}, {1709, 0}},
	{{31265, 0}, {17608, 0}, {5224, 0}},
}

var CompBwdRefCDFDefault = [2][3][2]uint16{
	{{30533, 0}, {15586, 0}, {2162, 0}},
	{{31345, 0}, {17593, 0}, {2279, 0}},
}

var CompUniRefCDFDefault = [3][3][2]uint16{
	{{27484, 0}, {9616, 0}, {994, 0}},
	{{28903, 0}, {18595, 0}, {7648, 0}},
	{{29640, 0}, {17498, 0}, {6058, 0}},
}

// Eight compound inter modes: seven inverse CDF values, counter, padding.
var CompInterModeCDFDefault = [8][9]uint16{
...
var JntCompCDFDefault = [6][2]uint16{
	{14524, 0}, {19903, 0}, {25715, 0}, {19509, 0}, {23434, 0}, {28124, 0},
}

var MaskCompCDFDefault = [6][2]uint16{
	{6161, 0}, {9877, 0}, {13928, 0}, {8174, 0}, {12834, 0}, {10094, 0},
}

var WedgeCompCDFDefault = [9][2]uint16{
	{9337, 0}, {19597, 0}, {21298, 0}, {22998, 0}, {23668, 0},
	{24535, 0}, {26596, 0}, {20948, 0}, {25067, 0},
}
